...
import type { OutputFormatId } from "@/lib/generators";
...
const SvelteIcon = (props: IconProps) => (
  <svg viewBox="0 0 300 300" aria-hidden="true" {...props}>
    <path
      fill="#ff5722"
 ...
 */
export const MarkdownMark = (props: IconProps) => (
  <svg viewBox="0 0 208 128" aria-hidden="true" {...props}>
    <path
      fill="none"
      stroke="currentColor"
      strokeWidth={10}
...
export const STACK_ICONS: Record<OutputFormatId, (props: IconProps) => React.JSX.Element> = {
  html: HtmlIcon,
  json: JsonIcon,
  nextjs: NextIcon,
  astro: AstroIcon,
